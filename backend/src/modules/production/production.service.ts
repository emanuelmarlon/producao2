...
import { ProductionOrder, ProductionOrderItem } from '@prisma/client';

interface CreateProductionOrderDto extends Omit<ProductionOrder, 'id' | 'createdAt' | 'updatedAt' | 'quantityReal' | 'startDate' | 'endDate' | 'lotNumber'> {
    items: Omit<ProductionOrderItem, 'id' | 'productionOrderId' | 'quantityReal' | 'lotUsedId'>[];
}
...
export class ProductionService {
    ...
    async update(id: string, data: Partial<CreateProductionOrderDto>) {

...
export class StatisticsController {
    async getKPIs(req: Request, res: Response) {
        try {
            ...
            const pendingFormulas = await prisma.formula.count({
                where: {
                    status: 'draft'
                }
            });
    ...
    async getProductionByMonth(req: Request, res: Response) {
        try {
    ...
    async getStockTrend(req: Request, res: Response) {
        try {
    ...
    async getCostDistribution(req: Request, res: Response) {
        try {
